...
public class InsertStudentsMessageDialog extends JDialog {
...
//	public boolean okReturn = false; 	// 是否成功保存后返回
	...
	public InsertStudentsMessageDialog() {
		setFont(new Font("Microsoft YaHei UI", Font.PLAIN, 13));
		setBackground(SystemColor.window);
		setIconImage(Toolkit.getDefaultToolkit().getImage(InsertStudentsMessageDialog.class.getResource("/Images/StudentsMessageDialog_Add.png")));
		init();
		this.studentsMessage = new StudentsMessage();
		this.studentsMessage.setId(0);
		//默认复选框勾选状态
		this.studentsMessage.setActive(true);
		//默认填入当前时间
		this.studentsMessage.setStartSchoolDate(new Date());
		showStudentsMessage();//在窗体上显示当前学生信息
	}
	...
	public void init() {
		...
		lblDepartment.setFont(new Font("Microsoft YaHei UI", Font.PLAIN, 14));
		...
		chkActive.setBounds(378, 253, 99, 23);
		...
		tbID.setFont(new Font("Microsoft YaHei UI", Font.PLAIN, 14));
		...
		lblStartSchool.setBounds(45, 257, 79, 14);
		...
		tbStartSchool.setBounds(113, 256, 220, 20);
		...
		tbStartSchool.setColumns(10);
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnConfirm.setIcon(new ImageIcon(InsertStudentsMessageDialog.class.getResource("/Images/Confrim.png")));
			...
			}
			{
				...
				btnCancel.setIcon(new ImageIcon(InsertStudentsMessageDialog.class.getResource("/Images/Cancel.png")));
